...
class POST(models.Model):
    ...
    LIKES = models.ManyToManyField("User", related_name="No_likes",null=True,blank=True)
...
class USERPROFILE(models.Model):
    ...
    FOLLOWERS = models.ManyToManyField("User", related_name="No_followers",null=True,blank=True)
    FOLLOWING = models.ManyToManyField("User", related_name="No_following",null=True,blank=True)
